...
public class PromptGenerator{
    ...
    public void DisplayQuestion(){
        ...
        newEntry.AddingPrompt(tempPrompt);   // Return a random question between 0-index and max-index.
 
        Console.WriteLine("Please insert an entry\n"); 

        DateTime theCurrentTime = DateTime.Now;
        newEntry._DateTime.Add(theCurrentTime.ToShortDateString());

        Console.Write($"{newEntry._Prompt}\n{newEntry._DateTime} > ");
        newEntry._UserInput.Add(Console.ReadLine());
